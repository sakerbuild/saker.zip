...
import testing.saker.zip.direct.transformers.SkipDirectoriesZipResourceTransformerFactory;
import testing.saker.zip.test.utils.ZipCreatorUtils;

@SakerTest
public class RemoveDirectoryDirectZipCreateTest extends SakerTestCase {
	...
	public void runTest(Map<String, String> parameters) throws Throwable {
		...
		builder.addResourceTransformer(new SkipDirectoriesZipResourceTransformerFactory());
		...
		ZipCreatorUtils.assertSameContents(TestUtils.<String, String>treeMapBuilder().put("readme.txt", "readme")
				.put("dir/sub.txt", "sub").build(), bytes);
